export const MY_FIRST_TOKEN_ABI = [
  {
    "inputs": [
      {
...
export const MY_FIRST_TOKEN_ADDRESS = process.env.NEXT_PUBLIC_CONTRACT_ADDRESS as `0x${string}`;

export const TOKEN_CONTRACT = {
  address: MY_FIRST_TOKEN_ADDRESS,
